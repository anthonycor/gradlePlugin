...
class SourceDistribution extends DistributionTask
{
    @TaskAction
    void doAction()
    {
        ...
        ant.zip(destfile: "${dir}/LabKey${project.installerVersion}-src.zip") {
        ...
        ant.tar(destfile: "${dir}/LabKey${project.installerVersion}-src.tar.gz",
                longfile:"gnu",
                compression: "gzip") {
